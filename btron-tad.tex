...
\author{Synrc / B-TRON Cleanroom Working Group}
\date{2026}
...
\begin{enumerate}[leftmargin=*]
  \item Forms are ordinary TAD documents and participate fully in the 実身/仮身 hypertext model.
...
%----------------------------------------------------------------------
\section{Core Abstraction --- The Form}
...
All drawing is performed through official Drawing Environments (描画環境).  
...
%----------------------------------------------------------------------
\section{Layout and Custom Rendering}
...
%----------------------------------------------------------------------
\section{Semantic Mapping (HTML5-inspired)}
...
%----------------------------------------------------------------------
\section{Data Binding and Validation}
...
\begin{itemize}[leftmargin=*]
  ...
  \item The data instance can itself be a TAD document, preserving the 実身/仮身 model.
\end{itemize}
...
%----------------------------------------------------------------------
\section{Relationship to Existing BTRON Components}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{TAD + 実身/仮身} --- persistence, hyperlinking, and document-centric nature.
